...
const char *ssid =  "Wizdem";     // replace with your wifi ssid and wpa2 key
const char *pass =  "wizdemroxx";
String postStr;
...
void loop() 
{
    ...
    http.begin("http://192.168.43.53:8000/api/save-data/");              //Specify request destination
